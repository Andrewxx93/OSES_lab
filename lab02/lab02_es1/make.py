...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Make file for application default
...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file lab02_es1_prof.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=posix/linux --templates=../../../goil/templates/ lab02_es1_prof.oil")
	sys.exit(1)
...
#--- Add generated files
sourceList.append("lab02_es1_prof/tpl_app_config.c")

sourceList.append("lab02_es1_prof/tpl_os.c")
