...
#--- OIL file
oilSourceList.append("exercise1.oil")
...
cSourceList.append(projfile.ProjectFile("exercise1.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("exercise1/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("exercise1/tpl_os.c"))
