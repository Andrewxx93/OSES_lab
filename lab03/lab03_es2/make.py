...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file exercise2.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=posix/linux --templates=../../../goil/templates exercise2.oil")
	sys.exit(1)
...
#--- Add generated files
sourceList.append("exercise2/tpl_app_config.c")

sourceList.append("exercise2/tpl_os.c")
