 ...
 * Automatically generated by goil on Tue Nov 30 00:33:16 2021
 * from root OIL file exercise2.oil
 *
...
/* Resource pippo */
#define pippo_id 0
CONST(ResourceType, AUTOMATIC) pippo = pippo_id;
...
#include "tpl_memmap.h"
/*-----------------------------------------------------------------------------
 * Resource descriptor of resource pippo
 *
 * Tasks which use this resource :
 * tau_A
 * tau_C
 */
VAR(tpl_resource, OS_VAR) pippo_rez_desc = {
