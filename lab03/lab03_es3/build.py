...
#--- OIL file
oilSourceList.append("exercise3.oil")
...
cSourceList.append(projfile.ProjectFile("exercise3.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("exercise3/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("exercise3/tpl_os.c"))
