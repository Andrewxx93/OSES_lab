...
#--- OIL file
oilSourceList.append("lab01.oil")
...
cSourceList.append(projfile.ProjectFile("lab01.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("lab01/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("lab01/tpl_os.c"))
