...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Build file for application default
...
sys.path.append("/home/andrew/trampoline/make")
...
cflags += "-O0 -ggdb".split()
includeDirs += ["-I","/home/andrew/trampoline/machines/posix"]
includeDirs += ["-I","/home/andrew/trampoline/machines/../viper"]
if with_ioc:
  includeDirs += ["-I", "/home/andrew/trampoline/ioc"]
includeDirs += ["-I", "/home/andrew/trampoline/os"]
includeDirs += ["-I", "/home/andrew/trampoline/debug"]
includeDirs += ["-I", "lab02_es2"]
cflags   += includeDirs
...
#--- OIL file
oilSourceList.append("lab02_es2.oil")
...
cflags += ["-I", "/home/andrew/trampoline/com"]
cppflags += ["-I", "/home/andrew/trampoline/com"]
cSourceList.append(projfile.ProjectFile("com/tpl_com_app_copy.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("com/tpl_com_filtering.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("com/tpl_com_filters.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("com/tpl_com_internal_com.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("com/tpl_com_notification.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("com/tpl_com_queue.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("com/tpl_com_errorhook.c", trampoline_base_path))
...
cSourceList.append(projfile.ProjectFile("com/tpl_com_message_kernel.c", trampoline_base_path))

#--- Add C files of the application
cSourceList.append(projfile.ProjectFile("lab02_es2.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("lab02_es2/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("lab02_es2/tpl_os.c"))
...
postVariableMapping = dict(
  MACHINE_PATH='/home/andrew/trampoline/machines',
  ARCH_PATH='/home/andrew/trampoline/machines/posix',
  BOARD_PATH='/home/andrew/trampoline/machines/posix/linux',
  TARGET='posix/linux'
)
