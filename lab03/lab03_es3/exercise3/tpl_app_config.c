...
CONST(tpl_appmode_mask, OS_CONST) tpl_task_app_mode[TASK_COUNT] = {
  1 /* task tau_C : stdAppmode */ ,
  1 /* task tau_B : stdAppmode */ ,
  1 /* task tau_A : stdAppmode */ ,
  1 /* task initialization_task : stdAppmode */ ,
  0 /* task stop :  */ 
};

CONST(tpl_appmode_mask, OS_CONST) tpl_alarm_app_mode[ALARM_COUNT] = {
  1 /* alarm A : stdAppmode */ ,
  1 /* alarm B : stdAppmode */ ,
  1 /* alarm C : stdAppmode */ ,
  1 /* alarm initialization_alarm : stdAppmode */ ,
...
/* Task tau_C identifier */
#define tau_C_id 0
CONST(TaskType, AUTOMATIC) tau_C = tau_C_id;

/* Task tau_B identifier */
#define tau_B_id 1
CONST(TaskType, AUTOMATIC) tau_B = tau_B_id;

/* Task tau_A identifier */
#define tau_A_id 2
CONST(TaskType, AUTOMATIC) tau_A = tau_A_id;

/* Task initialization_task identifier */
#define initialization_task_id 3
CONST(TaskType, AUTOMATIC) initialization_task = initialization_task_id;
...
/* Alarm A identifier */
#define A_id 0
CONST(AlarmType, AUTOMATIC) A = A_id;

/* Alarm B identifier */
#define B_id 1
CONST(AlarmType, AUTOMATIC) B = B_id;

/* Alarm C identifier */
#define C_id 2
CONST(AlarmType, AUTOMATIC) C = C_id;

/* Alarm initialization_alarm identifier */
#define initialization_alarm_id 3
CONST(AlarmType, AUTOMATIC) initialization_alarm = initialization_alarm_id;
...
#define object_id 0
CONST(MessageIdentifier, AUTOMATIC) object = object_id;
...
#define message_id 0
CONST(MessageIdentifier, AUTOMATIC) message = message_id;
 ...
 */
/*-----------------------------------------------------------------------------
 * Task tau_C descriptor
 */
#define APP_Task_tau_C_START_SEC_CODE

#include "tpl_memmap.h"
/*
 * Task tau_C function prototype
 */

FUNC(void, OS_APPL_CODE) tau_C_function(void);
#define APP_Task_tau_C_STOP_SEC_CODE
 ...
 * Task tau_C stack
 */
#define APP_Task_tau_C_START_SEC_STACK
#include "tpl_memmap.h"
tpl_stack_word tau_C_stack_zone[32768/sizeof(tpl_stack_word)];
#define APP_Task_tau_C_STOP_SEC_STACK
#include "tpl_memmap.h"

#define OS_START_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"
struct TPL_STACK tau_C_stack = {tau_C_stack_zone, 32768};
#define OS_STOP_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"

#define tau_C_STACK &tau_C_stack
...
#define OS_START_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"
struct TPL_CONTEXT tau_C_context;
#define OS_STOP_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"

#define tau_C_CONTEXT &tau_C_context
...
/*
 * Static descriptor of task tau_C
 */
CONST(tpl_proc_static, OS_CONST) tau_C_task_stat_desc = {
  /* context                  */  tau_C_CONTEXT,
  /* stack                    */  tau_C_STACK,
  /* entry point (function)   */  tau_C_function,
  /* internal ressource       */  NULL,
  /* task id                  */  tau_C_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task tau_C
 */
VAR(tpl_proc, OS_VAR) tau_C_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
...
/*-----------------------------------------------------------------------------
 * Task tau_B descriptor
 */
#define APP_Task_tau_B_START_SEC_CODE

#include "tpl_memmap.h"
/*
 * Task tau_B function prototype
 */

FUNC(void, OS_APPL_CODE) tau_B_function(void);
#define APP_Task_tau_B_STOP_SEC_CODE
 ...
 * Task tau_B stack
 */
#define APP_Task_tau_B_START_SEC_STACK
#include "tpl_memmap.h"
tpl_stack_word tau_B_stack_zone[32768/sizeof(tpl_stack_word)];
#define APP_Task_tau_B_STOP_SEC_STACK
#include "tpl_memmap.h"

#define OS_START_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"
struct TPL_STACK tau_B_stack = {tau_B_stack_zone, 32768};
#define OS_STOP_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"

#define tau_B_STACK &tau_B_stack
...
#define OS_START_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"
struct TPL_CONTEXT tau_B_context;
#define OS_STOP_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"

#define tau_B_CONTEXT &tau_B_context
...
/*
 * Static descriptor of task tau_B
 */
CONST(tpl_proc_static, OS_CONST) tau_B_task_stat_desc = {
  /* context                  */  tau_B_CONTEXT,
  /* stack                    */  tau_B_STACK,
  /* entry point (function)   */  tau_B_function,
  /* internal ressource       */  NULL,
  /* task id                  */  tau_B_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task tau_B
 */
VAR(tpl_proc, OS_VAR) tau_B_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
...
/*-----------------------------------------------------------------------------
 * Task tau_A descriptor
 */
#define APP_Task_tau_A_START_SEC_CODE

#include "tpl_memmap.h"
/*
 * Task tau_A function prototype
 */

FUNC(void, OS_APPL_CODE) tau_A_function(void);
#define APP_Task_tau_A_STOP_SEC_CODE
 ...
 * Task tau_A stack
 */
#define APP_Task_tau_A_START_SEC_STACK
#include "tpl_memmap.h"
tpl_stack_word tau_A_stack_zone[32768/sizeof(tpl_stack_word)];
#define APP_Task_tau_A_STOP_SEC_STACK
#include "tpl_memmap.h"

#define OS_START_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"
struct TPL_STACK tau_A_stack = {tau_A_stack_zone, 32768};
#define OS_STOP_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"

#define tau_A_STACK &tau_A_stack
...
#define OS_START_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"
struct TPL_CONTEXT tau_A_context;
#define OS_STOP_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"

#define tau_A_CONTEXT &tau_A_context
...
/*
 * Static descriptor of task tau_A
 */
CONST(tpl_proc_static, OS_CONST) tau_A_task_stat_desc = {
  /* context                  */  tau_A_CONTEXT,
  /* stack                    */  tau_A_STACK,
  /* entry point (function)   */  tau_A_function,
  /* internal ressource       */  NULL,
  /* task id                  */  tau_A_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task tau_A
 */
VAR(tpl_proc, OS_VAR) tau_A_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
...
/*-----------------------------------------------------------------------------
 * Task initialization_task descriptor
 */
#define APP_Task_initialization_task_START_SEC_CODE

#include "tpl_memmap.h"
/*
 * Task initialization_task function prototype
 */

FUNC(void, OS_APPL_CODE) initialization_task_function(void);
#define APP_Task_initialization_task_STOP_SEC_CODE
 ...
 */
/*
 * Task initialization_task stack
 */
#define APP_Task_initialization_task_START_SEC_STACK
#include "tpl_memmap.h"
tpl_stack_word initialization_task_stack_zone[32768/sizeof(tpl_stack_word)];
#define APP_Task_initialization_task_STOP_SEC_STACK
#include "tpl_memmap.h"

#define OS_START_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"
struct TPL_STACK initialization_task_stack = {initialization_task_stack_zone, 32768};
#define OS_STOP_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"

#define initialization_task_STACK &initialization_task_stack

/*
 * Task initialization_task context
 */
#define OS_START_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"
struct TPL_CONTEXT initialization_task_context;
#define OS_STOP_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"

#define initialization_task_CONTEXT &initialization_task_context
...
/*
 * Static descriptor of task initialization_task
 */
CONST(tpl_proc_static, OS_CONST) initialization_task_task_stat_desc = {
  /* context                  */  initialization_task_CONTEXT,
  /* stack                    */  initialization_task_STACK,
  /* entry point (function)   */  initialization_task_function,
  /* internal ressource       */  NULL,
  /* task id                  */  initialization_task_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
#endif
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task initialization_task
 */
VAR(tpl_proc, OS_VAR) initialization_task_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
...
tpl_stat_proc_table[TASK_COUNT+ISR_COUNT+1] = {
  &tau_C_task_stat_desc,
  &tau_B_task_stat_desc,
  &tau_A_task_stat_desc,
  &initialization_task_task_stat_desc,
  &stop_task_stat_desc,
 ...
 * Alarm A descriptor
 *
 * This alarm does the activation of task tau_A
 */
...
CONST(tpl_task_activation_action, OS_CONST) A_action = {
  {
...
CONST(tpl_alarm_static, OS_CONST) A_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , A_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&A_action
};
...
VAR(tpl_time_obj, OS_VAR) A_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&A_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  100,
    /* date                         */  100,
 ...
 * Alarm B descriptor
 *
 * This alarm does the activation of task tau_B
 */
...
CONST(tpl_task_activation_action, OS_CONST) B_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  tau_B_id
...
CONST(tpl_alarm_static, OS_CONST) B_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , B_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&B_action
};
...
VAR(tpl_time_obj, OS_VAR) B_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&B_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  150,
    /* date                         */  150,
 ...
 * Alarm C descriptor
 *
 * This alarm does the activation of task tau_C
 */
...
CONST(tpl_task_activation_action, OS_CONST) C_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  tau_C_id
...
CONST(tpl_alarm_static, OS_CONST) C_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , C_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&C_action
};
...
VAR(tpl_time_obj, OS_VAR) C_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&C_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  280,
    /* date                         */  280,
...
/*-----------------------------------------------------------------------------
 * Alarm initialization_alarm descriptor
 *
 * This alarm does the activation of task initialization_task
 */
...
CONST(tpl_task_activation_action, OS_CONST) initialization_alarm_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  initialization_task_id
...
CONST(tpl_alarm_static, OS_CONST) initialization_alarm_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , initialization_alarm_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&initialization_alarm_action
};
...
VAR(tpl_time_obj, OS_VAR) initialization_alarm_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&initialization_alarm_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  0,
    /* date                         */  0,
...
CONSTP2VAR(tpl_time_obj, AUTOMATIC, OS_APPL_DATA)
  ...
  &B_alarm_desc,
  &C_alarm_desc,
  &initialization_alarm_alarm_desc,
  &stopper_alarm_desc
};
#define OS_STOP_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"
 ...
 */
/*
 * NEWISDIFFERENT filter function for type uint32
 */

FUNC(tpl_bool, OS_CODE) newisdifferent_uint_33__32_(
...
{
  return (tpl_bool)((*((uint32 *)new_value)) != (*((uint32 *)old_value)));
}
...
/*-----------------------------------------------------------------------------
 * Action of message object
 */
/*-----------------------------------------------------------------------------
 * NEWISDIFFERENT filter of message object object
 */
#define OS_START_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"

tpl_noparam_filter_desc object_filter = {
    /*  filtering function          */  newisdifferent_uint_33__32_
};
...
/*-----------------------------------------------------------------------------
 * Static internal receiving unqueued message object object
 */
#define OS_START_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"

VAR(uint32, OS_VAR) object_buffer = 0;
...
CONST(tpl_internal_receiving_unqueued_mo, OS_CONST) object_message = {
  { /* data receiving mo struct   */
    ...
    /*  filter pointer          */  (tpl_filter_desc *)&object_filter
  },
  { /* buffer struct    */
    /*  buffer  */  (tpl_com_data *)&object_buffer,
    /*  size    */  sizeof(uint32)
  }
};
...
tpl_receive_message_table[RECEIVE_MESSAGE_COUNT] = {
  (tpl_base_receiving_mo*)&object_message
};
...
/*-----------------------------------------------------------------------------
 * Static internal sending static message object message
 */
CONST(tpl_internal_sending_mo, OS_CONST) message_message = {
  { /* base message object       */
    /* sending function          */ tpl_send_static_internal_message
  },
  /* pointer to the receiving mo */ (tpl_base_receiving_mo *)&object_message
};
...
tpl_send_message_table[SEND_MESSAGE_COUNT] = {
  (tpl_base_sending_mo*)&message_message
};
