 ...
 * Automatically generated by goil on Wed Oct 27 16:00:30 2021
 * from root OIL file lab01.oil
 *
...
/* Alarm a750_msec identifier */
#define a750_msec_id 1
CONST(AlarmType, AUTOMATIC) a750_msec = a750_msec_id;
...
CONST(tpl_task_activation_action, OS_CONST) a750_msec_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  TaskB_id
...
CONST(tpl_alarm_static, OS_CONST) a750_msec_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , a750_msec_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&a750_msec_action
};
...
VAR(tpl_time_obj, OS_VAR) a750_msec_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&a750_msec_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  75,
    /* date                         */  150,
