...
#--- OIL file
oilSourceList.append("exercise2.oil")
...
cSourceList.append(projfile.ProjectFile("exercise2.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("exercise2/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("exercise2/tpl_os.c"))
